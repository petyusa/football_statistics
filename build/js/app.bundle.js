...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _urlResolver = __webpack_require__(/*! ./urlResolver */ \"./src/js/api/urlResolver.js\");\n\nvar _urlResolver2 = _interopRequireDefault(_urlResolver);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Http = function () {\n    function Http(apiKey) {\n        _classCallCheck(this, Http);\n\n        this.apiKey = apiKey;\n        this.urlResolver = new _urlResolver2.default('http://api.football-data.org/v1');\n    }\n\n    _createClass(Http, [{\n        key: '_get',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {\n                var response, json;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.next = 2;\n                                return window.fetch(url, {\n                                    method: 'GET',\n                                    headers: {\n                                        'X-Auth-Token': this.apiKey\n                                    }\n                                });\n\n                            case 2:\n                                response = _context.sent;\n                                _context.next = 5;\n                                return response.json();\n\n                            case 5:\n                                json = _context.sent;\n                                return _context.abrupt('return', json);\n\n                            case 7:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this);\n            }));\n\n            function _get(_x) {\n                return _ref.apply(this, arguments);\n            }\n\n            return _get;\n        }()\n    }, {\n        key: 'getCompetition',\n        value: function getCompetition(competitionId) {\n            var url = this.urlResolver.getUrl('competition', { competitionId: competitionId });\n            return this._get(url);\n        }\n    }, {\n        key: 'getCompetitions',\n        value: function getCompetitions(season) {\n            var url = void 0;\n            if (season) {\n                url = this.urlResolver.getUrl('competitions', {}, { season: season });\n            } else {\n                url = this.urlResolver.getUrl('competitions', {}, {});\n            }\n            return this._get(url);\n        }\n    }, {\n        key: 'getTeam',\n        value: function getTeam(teamId) {\n            var url = this.urlResolver.getUrl('team', { teamId: teamId }, {});\n            return this._get(url);\n        }\n    }, {\n        key: 'getTeamsByCompetition',\n        value: function getTeamsByCompetition(competitionId) {\n            var url = this.urlResolver.getUrl('teams', { competitionId: competitionId }, {});\n            return this._get(url);\n        }\n    }, {\n        key: 'getFixture',\n        value: function getFixture(fixtureId) {\n            var url = this.urlResolver.getUrl('fixture', { fixtureId: fixtureId });\n            return this._get(url);\n        }\n    }, {\n        key: 'getFixturesByCompetition',\n        value: function getFixturesByCompetition(competitionId, searchParams) {\n            var url = void 0;\n            if (searchParams) {\n                url = this.urlResolver.getUrl('fixturesByComp', { competitionId: competitionId }, searchParams);\n            } else {\n                url = this.urlResolver.getUrl('fixturesByComp', { competitionId: competitionId });\n            }\n            return this._get(url);\n        }\n    }, {\n        key: 'getLeagueTable',\n        value: function getLeagueTable(competitionId, matchday) {\n            var url = void 0;\n            if (matchday) {\n                url = this.urlResolver.getUrl('leagueTable', { competitionId: competitionId }, { matchday: matchday });\n            } else {\n                url = this.urlResolver.getUrl('leagueTable', { competitionId: competitionId }, {});\n            }\n            return this._get(url);\n        }\n    }, {\n        key: 'getPlayers',\n        value: function getPlayers(teamId) {\n            var url = this.urlResolver.getUrl('players', { teamId: teamId });\n            return this._get(url);\n        }\n    }]);\n\n    return Http;\n}();\n\nexports.default = Http;\n\n//# sourceURL=webpack:///./src/js/api/http.js?");
...
"use strict";
eval("\n\nvar _http = __webpack_require__(/*! ./api/http */ \"./src/js/api/http.js\");\n\nvar _http2 = _interopRequireDefault(_http);\n\nvar _ui = __webpack_require__(/*! ./api/ui */ \"./src/js/api/ui.js\");\n\nvar _ui2 = _interopRequireDefault(_ui);\n\nvar _leagueTable = __webpack_require__(/*! ./models/leagueTable */ \"./src/js/models/leagueTable.js\");\n\nvar _leagueTable2 = _interopRequireDefault(_leagueTable);\n\nvar _fixture = __webpack_require__(/*! ./models/fixture */ \"./src/js/models/fixture.js\");\n\nvar _fixture2 = _interopRequireDefault(_fixture);\n\nvar _player = __webpack_require__(/*! ./models/player */ \"./src/js/models/player.js\");\n\nvar _player2 = _interopRequireDefault(_player);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar api = new _http2.default('aea65a64efe24cd78a58c4de32a16c64');\nvar ui = new _ui2.default();\nvar clickMe = document.querySelector('.js-competitions');\nclickMe.addEventListener('click', function () {\n    api.getCompetitions().then(function (res) {\n        return ui.loadSideBar(res);\n    });\n});\n\nvar sideBar = document.querySelector('.js-side-bar');\nsideBar.addEventListener('click', function (e) {\n    var competition = e.target;\n    var competitionId = competition.getAttribute('data-competitionId');\n    ui.toggleSideBar(e.target);\n    ui.showLoader();\n    api.getLeagueTable(competitionId).then(function (res) {\n        var leagueTable = new _leagueTable2.default(res);\n        ui.loadCompetition(leagueTable);\n    }).then(function () {\n        var currentMatchday = competition.getAttribute('data-currentMatchday');\n        api.getFixturesByCompetition(competitionId, { matchday: currentMatchday }).then(function (res) {\n            var fixtures = [];\n            res.fixtures.forEach(function (fix) {\n                fixtures.push(new _fixture2.default(fix));\n            });\n            ui.loadFixtures(fixtures, '.js-current-fixtures');\n        }).then(function () {\n            api.getFixturesByCompetition(competitionId, { matchday: 1 }).then(function (res) {\n                var fixtures = [];\n                res.fixtures.forEach(function (fix) {\n                    fixtures.push(new _fixture2.default(fix));\n                });\n                ui.loadFixtures(fixtures, '.js-next-fixtures');\n                ui.hideLoader();\n            });\n        });\n    });\n});\n\nvar table = document.querySelector('.js-league-table');\ntable.addEventListener('click', function (e) {\n    var team = e.target.parentNode;\n    if (!team.classList.contains('js-team')) {\n        return;\n    }\n    var teamId = team.getAttribute('data-team-id');\n    api.getTeam(teamId).then(function (res) {\n        console.log(res.name);\n    }).then(function () {\n        api.getPlayers(teamId).then(function (res) {\n            var players = [];\n            res.players.forEach(function (item) {\n                players.push(new _player2.default(item));\n            });\n            console.log(players);\n        });\n    });\n});\n\nvar navButton = document.querySelector('.header__nav-button');\nnavButton.addEventListener('click', function () {\n    var sideBar2 = document.querySelector('.side-bar');\n    if (sideBar2.classList.contains('side-bar--open')) {\n        sideBar2.classList.remove('side-bar--open');\n    } else {\n        sideBar2.classList.add('side-bar--open');\n    }\n});\n\n//# sourceURL=webpack:///./src/js/app.js?");

/***/ }),

/***/ "./src/js/models/fixture.js":
/*!**********************************!*\
  !*** ./src/js/models/fixture.js ***!
  \**********************************/
/*! no static exports found */
